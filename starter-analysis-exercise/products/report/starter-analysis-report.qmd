...
@ht-edu shows box plots displaying height distributions by education level. All education levels had around the same maximum height. The group of those containing bachelor's degrees had the most variance in height, and those with less than a high school diploma had the least variance in height.
```{r}
#| label: ht-edu
#| fig-cap: "Height distributions stratified by education level."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","height-education.png"))
```

@book-wt shows a scatterplot with the number of books read in the past year on the y-axis and weight on the x-axis. The graph shows a weak negative correlation between the two, with the number of books read in a year slightly decreasing with increasing weight.
```{r}
#| label: book-wt
#| fig-cap: "Books read in a year vs. weight"
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","books-read_weight.png"))
```

@tbl3 shows the results of a linear regression model fitting height from education and number of books read in a year. No level of education nor the number of books read in a year were significant predictors of height.
```{r}
#| label: tbl3
#| tbl-cap: "Linear model fit table."
#| echo: FALSE
